...
export default function RecordingBorder() {
  ...
  // Dashed (not solid) so live annotation strokes drawn inside the region
  // can't be mistaken for the recording outline itself.
  return (
    <div
      className="fixed inset-0 pointer-events-none"
      style={{
        border: '3px dashed rgba(239,68,68,0.95)',
        borderRadius: 2,
